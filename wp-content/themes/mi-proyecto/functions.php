...
/* Registrando estilos */
   ...
   wp_register_style('fontawesome', 'https://use.fontawesome.com/releases/v5.3.1/css/all.css');
    ...
    // google fonts //
   wp_register_style('google-font1', 'https://fonts.googleapis.com/css?family=Archivo+Black');
   wp_register_style('google-font2', 'https://fonts.googleapis.com/css?family=PT+Serif'); 
